...
app: FastAPI = FastAPI(title="FastAPI App in Docker dev Container", description="A FastAPI app demonstrating all CRUD operations in a Docker dev container", version="1.0.0")
...
def read_root():
    ...
    """
    return {"message": "Welcome to the FastAPI App in Docker dev Container!"}
